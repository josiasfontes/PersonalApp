...
<div class="form-group">
		...
		<form:input class="form-control" path="altura" value="${medidas.altura}" />
		<br />
	
		<form:label path="peso">Peso</form:label>
		<form:input class="form-control" path="peso" value="${medidas.peso}" />
		<br />

		<form:label path="bicepsDireito">Biceps Direito</form:label>
		<form:input class="form-control" path="bicepsDireito" value="${medidas.bicepsDireito}" />
		<br />

		<form:label path="bicepsEsquerdo">Biceps Esquerdo</form:label>
		<form:input class="form-control" path="bicepsEsquerdo" value="${medidas.bicepsEsquerdo}" />
		<br />

		<form:label path="tricepsDireito">Triceps Direito</form:label>
		<form:input class="form-control" path="tricepsDireito" value="${medidas.tricepsDireito}" />
		<br />

		<form:label path="tricepsEsquerdo">Triceps Esquerdo</form:label>
		<form:input class="form-control" path="tricepsEsquerdo" value="${medidas.tricepsEsquerdo}" />
		<br />

		<form:label path="peitoral">Peitoral</form:label>
		<form:input class="form-control" path="peitoral" value="${medidas.peitoral}" />
		<br />

		<form:label path="abdomen">Abdomen</form:label>
		<form:input class="form-control" path="abdomen" value="${medidas.abdomen}" />
		<br />

		<form:label path="quadril">Quadril</form:label>
		<form:input class="form-control" path="quadril" value="${medidas.quadril}" />
		<br />

		<form:label path="coxaDireita">Coxa Direita</form:label>
		<form:input class="form-control" path="coxaDireita" value="${medidas.coxaDireita}" />
		<br />
		
		<form:label path="coxaEsquerda">Coxa Esquerda</form:label>
		<form:input class="form-control" path="coxaEsquerda" value="${medidas.coxaEsquerda}" />
		<br />
		
		<form:label path="gluteo">Gluteo</form:label>
		<form:input class="form-control" path="gluteo" value="${medidas.gluteo}" />
		<br />
		
		<form:label path="panturrilhaDireita">Panturrilha Direita</form:label>
		<form:input class="form-control" path="panturrilhaDireita" value="${medidas.panturrilhaDireita}" />
		<br />
		
		<form:label path="panturrilhaEsquerda">Panturrilha Esquerda</form:label>
		<form:input class="form-control" path="panturrilhaEsquerda" value="${medidas.panturrilhaEsquerda}" />
		<br />

		<form:label path="pessoa.idPessoa">ID PESSOA</form:label>
		<form:input class="form-control" path="pessoa.idPessoa" value="${medidas.pessoa.idPessoa}" />
		<br />
...
<footer class="main-footer">
        ...
        <strong>Copyright 2015 <a href="http://www.besche.com.br/site">Besche Soluções em Tecnologia LTDA</a>.</strong> Todos os direitos reservados.
      </footer>
    ...
    <!-- daterangepicker -->
    <script src="/resources/https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js" type="text/javascript"></script>
