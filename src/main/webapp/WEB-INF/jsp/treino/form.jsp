...
<div class="wrapper">
	...
	<form:form modelAttribute="treino" method="post" action="/treino/criar">
		...
		<form:input class="form-control" path="nome" value="${treino.nome}" />
		<br />

		<form:label path="observacao">Observacao</form:label>
		<form:input class="form-control" path="observacao" value="${treino.observacao}" />
		<br />

		<form:label path="pessoa.idPessoa">ID PESSOA</form:label>
		<form:input class="form-control" path="pessoa.idPessoa" value="${treino.pessoa.idPessoa}" />
		<br />
		...
		<table class="table">
			...
			<c:forEach items="${exercicios}" var="exercicio">
				<tr>
					...
					<td><input class="form-control" type="checkbox" name="exercicios" value="${exercicio.idExercicio}"></td>
