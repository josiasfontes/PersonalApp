...
<div class="wrapper">
	...
	<form:form modelAttribute="pessoa" method="post" action="/pessoa/criar">
		...
		<form:input class="form-control" path="nome" value="${pessoa.nome}" />
		<br />

		<form:label path="cpf">CPF</form:label>
		<form:input class="form-control" path="cpf" value="${pessoa.cpf}" />
		<br />

		<form:label path="sexo">Sexo</form:label>
		<form:input class="form-control" path="sexo" value="${pessoa.sexo}" />
		<br />

		<form:label path="idade">Idade</form:label>
		<form:input class="form-control" path="idade" value="${pessoa.idade}" />
		<br />

		<form:label path="email">Email</form:label>
		<form:input class="form-control" path="email" value="${pessoa.email}" />
		<br />
		
		<form:label path="senha">Senha</form:label>
		<form:input class="form-control" path="senha" value="${pessoa.senha}" />
		<br />

		<form:label path="telefone">Telefone</form:label>
		<form:input class="form-control" path="telefone" value="${pessoa.telefone}" />
		<br />

		<form:label path="academia.idAcademia">ID ACADEMIA</form:label>
		<form:input class="form-control" path="academia.idAcademia" value="${academia.idAcademia}" />
		<br />

		<form:label path="endereco.cep">CEP</form:label>
		<form:hidden path="endereco.idEndereco"	value="${pessoa.endereco.idEndereco}" />
		<form:input class="form-control" path="endereco.cep" value="${pessoa.endereco.cep}" />
		<br />
		...
		<form:input class="form-control" path="endereco.bairro" value="${pessoa.endereco.bairro}" />
		<br />

		<form:label path="endereco.numero">Numero</form:label>
		<form:input class="form-control" path="endereco.numero" value="${pessoa.endereco.numero}" />
		<br />
		...
		<form:input class="form-control" path="endereco.cidade" value="${pessoa.endereco.cidade}" />
		<br />

		<form:label path="endereco.estado">Estado</form:label>
		<form:input class="form-control" path="endereco.estado" value="${pessoa.endereco.estado}" />
		<br />
