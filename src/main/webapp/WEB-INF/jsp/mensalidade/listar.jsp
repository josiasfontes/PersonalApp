...
<table class="table">
	...
	<tbody>
		<c:forEach items="${mensalidade}" var="mensalidade">
			<tr>
				<td>${mensalidade.idMensalidade}</td>
				...
				<td><a
					href="${pageContext.request.contextPath}/mensalidade/deletar/${mensalidade.idMensalidade}">
