...
<div class="wrapper">
	...
	<form:form role="form" modelAttribute="academia" method="post" action="/academia/criar">
                    			<div class="form-group">

		<form:label path="razaosocial">Razão social</form:label>
		<form:hidden path="idAcademia" value="${academia.idAcademia}"/>
		<form:input class="form-control" path="razaosocial" value="${academia.razaosocial}" /><br/>
		
		<form:label path="cnpj">CNPJ</form:label>
		<form:input class="form-control" path="cnpj" value="${academia.cnpj}" /><br/>
		
		<form:label path="nomeresponsavel">Nome Responsável</form:label>
		<form:input class="form-control" path="nomeresponsavel" value="${academia.nomeresponsavel}" /><br/>
		
		<form:label path="login">Login</form:label>
		<form:input class="form-control" path="login" value="${academia.login}" /><br/>
		
		<form:label path="senha">Senha</form:label>
		<form:input class="form-control" path="senha" value="${academia.senha}" /><br/>
		
		
		
		<form:label path="endereco.cep">CEP</form:label>
		<form:hidden path="endereco.idEndereco" value="${academia.endereco.idEndereco}"/>
		<form:input class="form-control" path="endereco.cep" value="${academia.endereco.cep}" /><br/>
		
		<form:label path="endereco.logradouro">Logradouro</form:label>
		<form:input class="form-control" path="endereco.logradouro" value="${academia.endereco.logradouro}" /><br/>
		
		<form:label path="endereco.bairro">Bairro</form:label>
		<form:input class="form-control" path="endereco.bairro" value="${academia.endereco.bairro}" /><br/>
		
		<form:label path="endereco.numero">Numero</form:label>
		<form:input class="form-control" path="endereco.numero" value="${academia.endereco.numero}" /><br/>
		
		<form:label path="endereco.complemento">Complemento</form:label>
		<form:input class="form-control" path="endereco.complemento" value="${academia.endereco.complemento}" /><br/>
		
		<form:label path="endereco.cidade">Cidade</form:label>
		<form:input class="form-control" path="endereco.cidade" value="${academia.endereco.cidade}" /><br/>
		
		<form:label path="endereco.estado">Estado</form:label>
		<form:input class="form-control" path="endereco.estado" value="${academia.endereco.estado}" /><br/>
